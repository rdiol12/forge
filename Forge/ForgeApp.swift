...
struct ForgeApp: App {
    ...
    var body: some Scene {
        WindowGroup {
            root
                ...
                .task(id: scenePhase) {
                    #if DEBUG
                    if ProcessInfo.processInfo.arguments.contains("--forge-preview-url") || ProcessInfo.processInfo.arguments.contains("--forge-preview-code") || ProcessInfo.processInfo.arguments.contains("--forge-preview-readme") { return }
                    #endif
    ...
    @ViewBuilder private var root: some View {
        ...
        if ProcessInfo.processInfo.arguments.contains("--forge-preview-readme"),
