...
- **Also verified in [build 10](https://github.com/rdiol12/forge-ios/actions/runs/35881348409):** all 24 tests present in 0.4 and 2 backend tests on macOS, complete device/simulator builds with Xcode 26.3, and light/dark Home plus native issue screenshots. The published [0.4.0 IPA](https://github.com/rdiol12/forge-ios/releases/tag/build-10-1) passed ZIP integrity, SHA-256, version, unsigned-package, and production OAuth-origin checks and matched its Actions artifact byte for byte. It targets iOS 17 and later. CI now selects Xcode explicitly and bounds simulator discovery and screenshot execution after a hosted simulator command stalled.
